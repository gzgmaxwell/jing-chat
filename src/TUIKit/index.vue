...
<template>
  <div :key="currentLanguage">
    <slot>
      <div class="TUIKit" :class="[isH5 && 'TUIKit-h5']">
        <div v-if="!(isH5 && currentConversationID)" class="TUIKit-navbar">
          <div
            v-for="item of navbarList"
            :key="item.id"
            class="TUIKit-navbar-item"
            :class="[currentNavbar === item.id && 'TUIKit-navbar-item-active']"
        ...
        <div class="TUIKit-main-container">
          ...
          <div v-else-if="currentNavbar === 'contact'" class="TUIKit-main">
            <TUIContact
              ...
              @switch-conversation="currentNavbar = 'message'"
            />
          </div>
        </div>
      </div>
