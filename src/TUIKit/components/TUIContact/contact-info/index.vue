...
function setEditing(item: any) {
  item.editing = true
}

const isGroup = computed((): boolean =>
  !!(contactInfoData.value as IGroupModel)?.groupID,
)
...
function resetContactInfoUIData() {
...
function resetContactSearchingUIData() {
...
function onContactInfoEmitSubmit(item: any) {
...
function onContactInfoButtonClicked(item: any) {
  item.onClick
  && item.onClick({
    contactInfoData: contactInfoData.value,
...
async function generateMoreInfo() {
...
<template>
  <div
    ...
    class="tui-contact-info" :class="[!isPC && 'tui-contact-info-h5']"
  >
    <div
      v-if="!isPC"
      class="tui-contact-info-header" :class="[
        !isPC && 'tui-contact-info-h5-header',
      ]"
    >
      <div
        class="tui-contact-info-header-icon" :class="[
      ...
      <div
        class="tui-contact-info-header-title" :class="[
    ...
    <div class="tui-contact-info-basic" :class="[!isPC && 'tui-contact-info-h5-basic']">
      <div
        class="tui-contact-info-basic-text" :class="[
          !isPC && 'tui-contact-info-h5-basic-text',
        ]"
      >
        <div
          class="tui-contact-info-basic-text-name" :class="[
        ...
        <div
          ...
          :key="item.label"
          class="tui-contact-info-basic-text-other" :class="[
      ...
      <img
        class="tui-contact-info-basic-avatar" :class="[
    ...
    <div
      ...
      class="tui-contact-info-more" :class="[!isPC && 'tui-contact-info-h5-more']"
    >
      <div
        v-for="item in contactInfoMoreList"
        :key="item.key"
        class="tui-contact-info-more-item" :class="[
      ...
      >
        <div
          class="tui-contact-info-more-item-label" :class="[
        ...
        <div
          class="tui-contact-info-more-item-content" :class="[
            !isPC && 'tui-contact-info-h5-more-item-content',
          ]"
        >
          <div
            v-if="!item.editing"
            class="tui-contact-info-more-item-content-text" :class="[
              !isPC && 'tui-contact-info-h5-more-item-content-text',
            ]"
          >
            <div
              class="tui-contact-info-more-item-content-text-data" :class="[
            ...
            <div
              v-if="item.editable"
              class="tui-contact-info-more-item-content-text-icon" :class="[
          ...
          <input
            ...
            v-model="item.data"
            class="tui-contact-info-more-item-content-input" :class="[
          ...
          <textarea
            ...
            v-model="item.data"
            class="tui-contact-info-more-item-content-textarea" :class="[
    ...
    <div
      class="tui-contact-info-button" :class="[
    ...
    >
      <button
        ...
        :key="item.key"
        class="tui-contact-info-button-item" :class="[
