...
<template>
  <ul
    ...
    :class="[!isPC && 'tui-contact-list-h5']"
  >
    <li
    ...
    >
      ...
      <ul
        ...
        :class="[currentContactListKey === key ? '' : 'hidden']"
      >
        <template v-if="key === 'friendList'">
          ...
          >
            ...
            <li
              ...
              class="tui-contact-list-item-main-item selected"
    ...
    >
      <div v-if="item.list[0]" class="tui-contact-search-list">
        ...
        <div
          ...
          :key="index"
          class="tui-contact-search-list-item selected"
          @click="selectItem(listItem)"
        >
          <ContactListItem :item="listItem" :display-online-status="false" />
        </div>
      </div>
    </li>
