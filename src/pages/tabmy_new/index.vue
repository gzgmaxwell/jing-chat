...
<template>
  <div class="my-container">
    ...
    <div class="bgimg text-white px-4 pb-3 pt-3 relative bg-gradient-to-b">
      ...
      <div
        class="text-xl mt-3 p-8px rounded-50% bg-[#0949AA] flex h-35px w-35px items-center right-16px absolute space-x-3"
        @click="scanBtn"
      >
        <van-icon name="scan" />
      </div>
    ...
    <div class="mx-4 mt-4 p-4 rounded-xl bg-white">
      <div class="gap-2 grid grid-cols-4">
        ...
        <div class="flex flex-col items-center space-y-2" @click="router.push('/realnameAuth_new')">
          <div class="relative">
            <div
              class="img-style rounded-lg bg-[#ECF1F7] flex items-center justify-center"
        ...
        >
          <div class="img-style rounded-lg bg-[#ECF1F7] flex items-center justify-center">
    ...
    <div class="mx-4 mt-4 space-y-4">
      ...
      <!-- 隐私/安全设置 -->
      <div class="mt-4 rounded-xl bg-white overflow-hidden">
